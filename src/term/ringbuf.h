...
extern void RingBufRead(tRingBufObject *psRingBuf, uint8_t *pui8Data, uint32_t ui32Length);
extern void RingBufWriteOne(tRingBufObject *psRingBuf, uint8_t ui8Data);
extern void RingBufWrite(tRingBufObject *psRingBuf, uint8_t *pui8Data, uint32_t ui32Length);
extern void RingBufAdvanceWrite(tRingBufObject *psRingBuf, uint32_t ui32NumBytes);
extern void RingBufAdvanceRead(tRingBufObject *psRingBuf, uint32_t ui32NumBytes);
extern void RingBufInit(tRingBufObject *psRingBuf, uint8_t *pui8Buf, uint32_t ui32Size);
