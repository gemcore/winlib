...
int luaD_rawrunprotected (lua_State *L, Pfunc f, void *ud) {
  ...
  TRACE("LUA: luaD_rawrunprotected(L=%08x,f=%08x,ud=%08x) lj=%08x previous=%08x TRY {\n",L,f,ud,&lj,L->errorJmp);
  lj.status = 0;
...
LUA_API int lua_resume (lua_State *L, int nargs) {
  ...
  TRACE("lua_resume() calling luaD_rawrunprotected: resume=%x ...\n",resume);
...
int luaD_pcall (lua_State *L, Pfunc func, void *u,
  ...
  L->errfunc = ef;
  TRACE("LUA: luaD_pcall() calling luaD_rawrunprotected: @func=%x ...\n",func);
